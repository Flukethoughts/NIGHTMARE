...
![Frame Assembly Day One](images/frame-assembly-day-one.jpg)
*Day one — frame assembly with my son.*

![NIGHTMARE Build](images/build-led-effects.jpg)
...
- **KlipperScreen** — Touch display (not yet installed)
...
- KlipperScreen display — screen and printed case on hand, install on hold until build is complete
